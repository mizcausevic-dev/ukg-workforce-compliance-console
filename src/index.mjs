...
const PRODUCT = {
  "repo": "ukg-workforce-compliance-console",
  "vendor": "UKG",
  "title": "workforce compliance console",
  "domain": "HR Tech / Workforce",
  "audience": "HR operations, compliance leaders, workforce systems owners, and CFO operators",
  "problem": "Workforce compliance issues hide in disconnected time, role, location, manager, and policy-attestation records.",
  "workflow": "The product maps workforce exceptions to accountable owners, remediation windows, policy proof, and executive-ready risk posture.",
  "business": "Leaders can distinguish ordinary HR noise from labor-cost exposure, compliance risk, and operational bottlenecks.",
  "technical": "A deterministic CLI scores synthetic workforce lanes and publishes a static proof packet safe for public review.",
  "integration": "UKG workforce records, schedules, attestations, manager hierarchies, and exception queues.",
  "keywords": [
    "UKG",
